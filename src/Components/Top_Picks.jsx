  ...
  return (
    ...
    <section id=' Top_Picks'  className='py-14 bg-white'>
        <div className="container">
            ...
            <p className='text-[16px] font-medium font-main text-[#9F9F9F] text-center mt-3.5'>Find a bright ideal to suit your taste with our great selection of suspension, floor and table lights.</p>
